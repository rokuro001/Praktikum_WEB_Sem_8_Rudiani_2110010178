            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('lokasi.create') }}" class="btn btn-primary btn-md float-right"> Tambah Lokasi</a>
                     <a href="{{ route('print.lokasi') }}" class="btn btn-success btn-md float-right"> Print Lokasi</a>
                     <a href="{{ route('grafik.lokasi') }}" class="btn btn-danger btn-md float-right"> Grafik Lokasi</a>
                     <a href="{{ route('export.excel.lokasi') }}" class="btn btn-info btn-md float-right"> Export excel</a>
                </div>
